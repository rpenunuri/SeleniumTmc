...
public abstract class BaseWebPageEntity {
    ...
    protected void waitForTextToChange(WebElement element, String text) {
        waitUntil(ExpectedConditions.not(ExpectedConditions.textToBePresentInElement(element, text)));
    }
